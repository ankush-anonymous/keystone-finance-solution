...
export default function TestimonialsSection() {
  return (
    ...
    >
      ...
      <div className="container mx-auto px-28 relative py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[600px]">
          ...
          <div className="text-white lg:pl-12">
            ...
            <p className="text-lg text-blue-100 mb-8 leading-relaxed max-w-md">
              Convallis Nec Ac Puruis Nunc. Maecenas Pharetra Scelerisque Tempor
              Vulputate Enim Bibendum Consectetur.
            </p>
